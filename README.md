...
Many such schools face a silent failure mode:
...
or drop out after problems are detected too late to reverse
...
Chronic absenteeism and grade collapse are often discovered only during promotion meetings
At that point, meaningful intervention is already too late
Compassion-Driven but Unstructured Decisions

Students are promoted out of pity rather than readiness
Admission decisions are made without prior student risk assessment
Intervention happens only after disengagement becomes severe
This system reframes data not as a tool for control,
but as an instrument for care, early support, and dignity preservation.
...
Early Intervention Over Late Punishment
